...
export const metadata = { title: 'Ахлах сургууль · Хянах самбар' };

export default async function HighSchoolDashboardPage() {
  ...
  return (
    <>
      <PageHeader
        ...
        subtitle="Соёл Эрдэм Ерөнхий боловсролын ахлах сургуулийн контентыг тусдаа удирдана"
        breadcrumb={[
