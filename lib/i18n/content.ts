...
export const HS_HOME_CONTENT: Record<Language, HsHomeBundle> = {
  MN: {
    ...
    breadcrumbThis: 'Соёл Эрдэм сургууль',
    ...
    bannerTitle: 'Соёл Эрдэм Сургууль',
    bannerSubtitle:
      'Чанартай боловсрол, Япон хэл, соёл, IT-ийн чиглэлээр ирээдүйгээ эндээс эхлүүл.',
...
export const HS_ABOUT_CONTENT: Record<Language, HsAboutBundle> = {
  MN: {
    ...
    breadcrumbUniversity: 'Дээд сургууль',
    breadcrumbHs: 'Соёл Эрдэм сургууль',
    ...
    directorRole: 'Захирал · Соёл Эрдэм сургууль',
    directorBody: [
      {
...
export const HS_PROGRAMS_CONTENT: Record<Language, HsProgramsBundle> = {
  MN: {
    ...
    jadeBody:
      '"Ногоон Жэйд" боловсролын төв нь 2013 оноос Соёл Эрдэм Сургуультай хамтран Англи, АНУ, Австрали, Канад зэрэг 10+ улсын 500+ их, дээд сургуультай зуучлал явуулж байна. Жил бүр 6,000+ оюутан зөвлөгөө авч, бэлдсэн сурагчдын 98% нь хүссэн сургуульдаа элсэн ордог. Манай сурагч ахлах ангиа төгсмөгцөө гадаадад үргэлжлүүлэн суралцах бэлэн замыг санал болгож байна.',
    jadeStats: [
...
export const HS_ADMISSION_CONTENT: Record<Language, HsAdmissionBundle> = {
  MN: {
    ...
    introBody:
      'Соёл Эрдэм Сургууль нь 10–11–12 ангид Япон хэл, соёл болон мэдээллийн технологид төрөлжсөн чанартай ерөнхий боловсрол олгодог. Эх сургууль СЭДС-ийн 30 жилийн япон судлалын баялаг туршлагаар суурилсан, япон 30+ их сургуультай хамтын ажиллагаатай сүлжээтэй.',
    infoBox: {
    ...
    bannerTitle: 'Соёл Эрдэм Сургуульд тавтай морил',
...
export const HS_CONTACT_CONTENT: Record<Language, HsContactBundle> = {
  MN: {
    ...
    messageCardBody:
      'Дээд сургуультай хамтран ажилладаг ерөнхий лавлах формыг ашиглан санал хүсэлтээ илгээж болно. Тус формыг хариуцсан ажилтан тантай 24 цагийн дотор холбоо барина.',
